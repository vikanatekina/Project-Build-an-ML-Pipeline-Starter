...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type =str,
        help ="Name of the output W&B artifact for the cleaned data",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type =str,
        help ="Type of the output W&B artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type =str,
        help ="Description of the output W&B artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type =float,
        help ="Minimum accepted price for a rental listing",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type =float,
        help ="Maximum accepted price for a rental listing",
        required = True
    )
